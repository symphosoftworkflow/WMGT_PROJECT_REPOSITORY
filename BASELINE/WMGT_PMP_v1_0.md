...
- **วิธีการสำรอง**: ใช้ระบบสำรองข้อมูลแบบ manual ที่มีการกำหนดงานสำรองข้อมูลผ่านเครื่องมือที่รองรับการทำงานอย่างต่อเนื่อง โดยการสำรองข้อมูลจะทำผ่านเซิร์ฟเวอร์สำรองที่มีความปลอดภัยและสามารถเข้าถึงได้ในกรณีฉุกเฉิน  
...
- **ความถี่ในการสำรองข้อมูล**:
  - **สำรองข้อมูลรายเดือน (Monthly Backup)**: ทำการสำรองข้อมูลทุกเดือน โดยจัดเก็บข้อมูลไว้ในระบบคลาวด์ระยะยาว (Google Drive) เพื่อความปลอดภัยและเข้าถึงได้ง่าย
...
- **Monthly Backup**: ทำการ Backup source code and database ทุกสิ้นเดือน โดยนำข้อมูลไปจัดเก็บไว้ที่ Google Drive รับผิดชอบโดย ปริญญา พงษ์ดนตรี [PR]
